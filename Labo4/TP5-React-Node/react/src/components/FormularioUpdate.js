...
const FormularioUpdate = ({ id }) => {
  //let instrumentoId = computedMatch.props.match.params.id;
  ...
  const { inputs, handleInputChange,handleInputChangeImage, handleSubmit, handleOnLoad } = useSignUpForm(signup, id);
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group col-md-6">
              ...
              >
                ...
                <div>
                  <img
                    src={url + instrumento.imagen}
                    name="imagen"
                    alt="imagen instrumento"
                  />
                  <span>{inputs.imagen}</span>
                  <br />
                  <br />
